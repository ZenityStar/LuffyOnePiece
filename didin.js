...
module.exports = GojoMdNx = async (GojoMdNx, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            GojoMdNx.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` DidinBotz‡`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./GojoMedia/gojo.jpg`),"sourceUrl": "https://telegra.ph/file/8bbe8a7de5c351dfcb077.jpg"}}}, { quoted: m})
        }
...
const reSize = (buffer, ukur1, ukur2) => {
    return new Promise(async(resolve, reject) => {
  	...
  	anu = `
Hy kak ${pushname} 
Saya Adalah DidinBotz Salah Satu Bot Whatsapp Yang Siap Membantu Kamu Mempermudah Sesuatu Seperti Membuat Sticker Dan Lainnya, Kalo Kamu Mau Request Fitur Silahkan Ketik #request Pesan Atau Fitur Yang Kamu Inginkan!`
    const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            hydratedContentText: anu,
                            locationMessage: {
                            jpegThumbnail: await reSize(fs.readFileSync('./GojoMedia/gojo.jpg'), 200, 200)},
                            hydratedFooterText: `@Didin_yt1`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'Instagram',
                                    url: `https://instagram.com/Didin_yt1`
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'MENU‡',
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    ...
                    sections: [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "Owner Menu",
										"description": "Menampilkan Daftar Fitur Pemilik",
									...
									{
										"title": "Rpg Menu",
										"description": "Menampilkan Daftar Fitur Rpg",
									...
									},
									{
										...
										"description": "Menampilkan Daftar Fitur Textpro",
										"rowId": `${prefix}textpromenu`
										},
										{
											"title": "Islamic Menu",
										"description": "Menampilkan Daftar Fitur Islami",
    ...
    case 'donasi': case 'donate': case 'donasi': case 'donasi': {
                GojoMdNx.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/51f38bac5fef37bde8a13.png' }, caption: `*Hi Bro ${m.pushName}*\n*_Jika ingin Donasi Silahkan Scan Gambar Diatas_*
...
*_Terima Kasih Bagi Yang Sudah Donasi_*\n` }, { quoted: m })
            ...
            break
            case 'sc': case 'script': {
                reply(`GitHub : https://github.com/didinsec\n Dont Forget To Give Star\n\nYouTube : ${myweb}\nDont Forget To Watch Tutorial`)
            }
            break
case 'allmenu': {
  	anu = `
    ...
    const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            hydratedContentText: anu,
                            locationMessage: {
                            jpegThumbnail: await reSize(fs.readFileSync('./GojoMedia/didin.jpg'), 200, 200)},
                            hydratedFooterText: `@Didin_yt1`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'Instagram',
...
case 'grupbot': {
                ...
                GojoMdNx.sendButtonText(m.chat, buttons, `Halo Kak ${await GojoMdNx.getName(m.sender)}\n\nGroup DidinBotz‡ : https://chat.whatsapp.com/GSZqXilXYMbH5Ou6FBlbJG\n\nJangan Lupa Join Ya kak hehe\nMakasih><`, GojoMdNx.user.name, m)
            }
			break
case 'mainmenu': {
const Jimp = require('jimp')
    ...
    const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            hydratedContentText: anu,
                            locationMessage: {
                            jpegThumbnail: await reSize(fs.readFileSync('./GojoMedia/menu.jpg'), 200, 200)},
                            hydratedFooterText: `DidinBotz‡`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'Instagram',
                                    url: `https://instagram.com/Didin_yt1`
...
┃╠${prefix}sell [option]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "Instagram‡","https://instagram.com/Didin_yt1": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi‡","id": 'donate'}},{"quickReplyButton": {"displayText": "BACK MENU‡","id": 'owner'}}] )
break
...
And Again Me (King Nexus 🎉) 🐦 Who Helped Assemble This Sexy Script !!!`,unicorn, [{"urlButton": {"displayText": "Instagram‡","https://instagram.com/Didin_yt1": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi‡","id": 'donate'}},{"quickReplyButton": {"displayText": "BACK MENU‡","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
